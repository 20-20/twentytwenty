          ...
          {trending.length &&
            <div className="tile is-ancestor">
              <div className="tile is-parent is-4" >
                <NavLink to={`/SingleArticle/${trending[0].id}`} id={trending[0].id} className="tile is-child box notification is-primary blur" style={{ backgroundImage: `linear-gradient(black, transparent), url('${trending[0].urlToImage}')`, backgroundPosition: 'center' }}>
              ...
              <div className="tile is-parent is-8 is-vertical">
                <NavLink to={`/SingleArticle/${trending[1].id}`} id={trending[1].id} className="tile is-child notification is-primary box blur" style={{ backgroundImage: `linear-gradient(black, transparent), url('${trending[1].urlToImage}')`, backgroundPosition: 'center' }}>
